...
const View0to9ChildMonthOldTable = () => {
    ...
    const fetchClients = async () => {
      try {
        const response = await axios.get(
          `health-center-repo-production.up.railway.app/0-59months-old/clients?worker_id=${workerId}&category_name=${encodeURIComponent(
  ...
  const handleAddForm = async (client: ClientType) => {
    ...
    try {
      const response = await axios.get(`health-center-repo-production.up.railway.app/zero_to_ninechildmonths-form/${client.id}`);
