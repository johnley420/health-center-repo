...
const ViewFilariasisTable = () => {
    ...
    const fetchClients = async () => {
      try {
        const response = await fetch(
          `health-center-repo-production.up.railway.app/filariasis/clients?worker_id=${workerId}&category_name=${encodeURIComponent(
  ...
  const handleAddForm = async (client: ClientType) => {
    ...
    try {
      const response = await fetch(`health-center-repo-production.up.railway.app/filariasis-form/${client.id}`);
      if (response.ok) {
