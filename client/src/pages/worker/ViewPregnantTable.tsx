...
const ViewPregnantCategoryTable = () => {
  ...
  useEffect(() => {
    const fetchClients = async () => {
      try {
        const response = await axios.get(
          `https://health-center-repo-production.up.railway.app/pregnant/clients?worker_id=${workerId}&category_name=${encodeURIComponent(
            "Pregnant"
          )}`
        );
    ...
    const fetchNextPrenatalVisitDate = async () => {
      try {
        const response = await axios.get("https://health-center-repo-production.up.railway.app/pregnant/get-next-visit-date");
  ...
  const handleAddForm = async (client: ClientType) => {
    ...
    try {
      const response = await axios.get(`https://health-center-repo-production.up.railway.app/pregnant-form/${client.id}`);
  ...
  const handleSetNextPrenatalVisit = async () => {
    ...
    try {
      const response = await axios.post("https://health-center-repo-production.up.railway.app/pregnant/check-missed-visits", {
