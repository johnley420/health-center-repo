    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          axios.get(`health-center-repo-production.up.railway.app/count-total-clients`, {
            params: { worker_id: workerId },
          }),
          axios.get(`health-center-repo-production.up.railway.app/count-male-clients`, {
            params: { worker_id: workerId },
          }),
          axios.get(`health-center-repo-production.up.railway.app/recent-clients`, {
            params: { worker_id: workerId },
          }),
          axios.get(`health-center-repo-production.up.railway.app/new-registered`, {
            params: { worker_id: workerId },
          }),
          axios.get(`health-center-repo-production.up.railway.app/category-count`, {
            params: { worker_id: workerId },
          }),
          axios.get(`health-center-repo-production.up.railway.app/age-segmentation`, {
            params: { worker_id: workerId },
          }),
          axios.get(`health-center-repo-production.up.railway.app/updates-line-graph`, { // Fetch updates data
            params: { worker_id: workerId },
          }),
        ]);
