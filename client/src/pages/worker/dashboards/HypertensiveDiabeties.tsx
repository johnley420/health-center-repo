...
const HypertensiveDiabeties: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          axios.get(`http://localhost:8081/hypertensivediabeties/count-total-clients`, {
            params: { worker_id: workerId, category_name: "Hypertensive And Type 2 Diabetes" },
          }),
          axios.get(`http://localhost:8081/hypertensivediabeties/age-segmentation`, {
            params: { worker_id: workerId, category_name: "Hypertensive And Type 2 Diabetes" },
          }),
          axios.get(`http://localhost:8081/hypertensivediabeties/new-registered`, {
            params: { worker_id: workerId, category_name: "Hypertensive And Type 2 Diabetes" },
          }),
          axios.get(`http://localhost:8081/hypertensivediabeties/hypertensivediabeties-data`, {
  ...
  const downloadPDF = async () => {
    try {
      ...
      const response = await axios.get('http://localhost:8081/print/hypertensivediabeties', {
        params: { worker_id: workerId },
