...
const MonthsChildren059: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          axios.get(`https://health-center-repo-production.up.railway.app/children059/count-total-clients`, {
            params: { worker_id: workerId, category_name: "0-59 Months Old Children" },
          }),
          axios.get(`https://health-center-repo-production.up.railway.app/children059/age-segmentation`, {
            params: { worker_id: workerId, category_name: "0-59 Months Old Children" },
          }),
          axios.get(`https://health-center-repo-production.up.railway.app/children059/new-registered`, {
            params: { worker_id: workerId, category_name: "0-59 Months Old Children" },
          }),
          axios.get(`https://health-center-repo-production.up.railway.app/children059/children059-data`, {
  ...
  const downloadPDF = async () => {
    try {
      ...
      const response = await axios.get('https://health-center-repo-production.up.railway.app/print/children059', {
        params: { worker_id: workerId },
