...
import MonthsChildren059CategoryDashboard from "../../../components/dashboard/MonthsChildren059CategoryDashboard";
...
// Props for MonthsChildren059CategoryDashboard


const MonthsChildren059: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          axios.get(`https://https://health-center-repo-production.up.railway.app/children059/count-total-clients`, {
            params: { worker_id: workerId, category_name: "0-59 Months Old Children" },
          }),
          axios.get(`https://https://health-center-repo-production.up.railway.app/children059/age-segmentation`, {
            params: { worker_id: workerId, category_name: "0-59 Months Old Children" },
          }),
          axios.get(`https://https://health-center-repo-production.up.railway.app/children059/new-registered`, {
            params: { worker_id: workerId, category_name: "0-59 Months Old Children" },
          }),
          axios.get(`https://https://health-center-repo-production.up.railway.app/children059/children059-data`, {
        ...
        setCountData([
          {
            label: "Total Clients",
            value: totalClients,
            description: "Total number of clients in 0-59 Months Old Children Program Services.",
            active: true,
            withVariants: {
              male: maleClients,
  ...
  const downloadPDF = async () => {
    try {
      ...
      const response = await axios.get('https://https://health-center-repo-production.up.railway.app/print/children059', {
        params: { worker_id: workerId },
      ...
      link.href = url;
      link.setAttribute('download', 'ZeroFiftyNineMonths_Report.pdf');
  ...
  return (
    <div className="p-4">
      <MonthsChildren059CategoryDashboard
        countData={countData}
      ...
      <div className="flex justify-end mt-4">
        ...
        >
          Download 0-59 Months Old Children Report
        </button>
      </div>
    </div>
  );
...
export default MonthsChildren059;
