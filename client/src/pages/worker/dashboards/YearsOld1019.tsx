// src/pages/admin/dashboards/YearsOld1019ProgramService.tsx

import React, { useState, useEffect } from "react";
import axios from "axios";
import YearsOld1019CategoryDashboard from "../../../components/dashboard/YearsOld1019CategoryDashboard";
...
// Props for YearsOld1019CategoryDashboard


const YearsOld1019: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          axios.get(`https://https://health-center-repo-production.up.railway.app/children10to19/count-total-clients`, {
            params: { worker_id: workerId, category_name: "10-19 Years Old (Adolescents)" },
          }),
          axios.get(`https://https://health-center-repo-production.up.railway.app/children10to19/age-segmentation`, {
            params: { worker_id: workerId, category_name: "10-19 Years Old (Adolescents)" },
          }),
          axios.get(`https://https://health-center-repo-production.up.railway.app/children10to19/new-registered`, {
            params: { worker_id: workerId, category_name: "10-19 Years Old (Adolescents)" },
          }),
          axios.get(`https://https://health-center-repo-production.up.railway.app/children10to19/children10to19-data`, {
        ...
        setCountData([
          {
            label: "Total Clients",
            value: totalClients,
            description: "Total number of clients in 10-19 Years Old (Adolescents) Program Services.",
            active: true,
            withVariants: {
              male: maleClients,
  ...
  const downloadPDF = async () => {
    try {
      ...
      const response = await axios.get('https://https://health-center-repo-production.up.railway.app/print/children10to19', {
        params: { worker_id: workerId },
      ...
      link.href = url;
      link.setAttribute('download', 'Children10to19_Report.pdf');
  ...
  return (
    <div className="p-4">
      ...
      <div className="flex justify-end mt-4">
        ...
        >
          {downloading ? 'Downloading...' : 'Download Children10to19 Report'}
        </button>
      </div>
    </div>
  );
