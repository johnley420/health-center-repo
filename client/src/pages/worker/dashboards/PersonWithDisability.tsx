...
const PersonWithDisability: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          axios.get(`https://https://health-center-repo-production.up.railway.app/person-with-disabilities/count-total-clients`, {
            params: { worker_id: workerId, category_name: "Person With Disabilities" },
          }),
          axios.get(`https://https://health-center-repo-production.up.railway.app/person-with-disabilities/age-segmentation`, {
            params: { worker_id: workerId, category_name: "Person With Disabilities" },
          }),
          axios.get(`https://https://health-center-repo-production.up.railway.app/person-with-disabilities/new-registered`, {
            params: { worker_id: workerId, category_name: "Person With Disabilities" },
          }),
          axios.get(`https://https://health-center-repo-production.up.railway.app/person-with-disabilities/person-with-disabilities-data`, {
  ...
  const handlePrint = async () => {
    try {
      ...
      const response = await axios.get(`https://https://health-center-repo-production.up.railway.app/print/personwithdisability`, {
        params: { worker_id: workerId },
