...
const yearsChildren5to9: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          axios.get(`https://health-center-repo-production.up.railway.app/children5to9/count-total-clients`, {
            params: { worker_id: workerId, category_name: "5-9 Years Old Children (School Aged Children)" },
          }),
          axios.get(`https://health-center-repo-production.up.railway.app/children5to9/age-segmentation`, {
            params: { worker_id: workerId, category_name: "5-9 Years Old Children (School Aged Children)" },
          }),
          axios.get(`https://health-center-repo-production.up.railway.app/children5to9/new-registered`, {
            params: { worker_id: workerId, category_name: "5-9 Years Old Children (School Aged Children)" },
          }),
          axios.get(`https://health-center-repo-production.up.railway.app/children5to9/children5to9-data`, {
  ...
  const downloadPDF = async () => {
    try {
      ...
      const response = await axios.get('https://health-center-repo-production.up.railway.app/print/children5to9', {
        params: { worker_id: workerId },
