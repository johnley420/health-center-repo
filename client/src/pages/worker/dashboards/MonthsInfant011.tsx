...
import MonthsInfant011CategoryDashboard from "../../../components/dashboard/MonthsInfant011CategoryDashboard";
...
// Props for MonthsInfant011CategoryDashboard


const MonthsInfant011: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          axios.get(`https://https://health-center-repo-production.up.railway.app/infants/count-total-clients`, {
            params: { worker_id: workerId, category_name: "0-11 Months Old Infants" },
          }),
          axios.get(`https://https://health-center-repo-production.up.railway.app/infants/age-segmentation`, {
            params: { worker_id: workerId, category_name: "0-11 Months Old Infants" },
          }),
          axios.get(`https://https://health-center-repo-production.up.railway.app/infants/new-registered`, {
            params: { worker_id: workerId, category_name: "0-11 Months Old Infants" },
          }),
          axios.get(`https://https://health-center-repo-production.up.railway.app/infants/infants-data`, {
        ...
        setCountData([
          {
            label: "Total Clients",
            value: totalClients,
            description: "Total number of clients in 0-11 Months Old Infants Program Services.",
            active: true,
            withVariants: {
              male: maleClients,
  ...
  const downloadPDF = async () => {
    try {
      ...
      const response = await axios.get('https://https://health-center-repo-production.up.railway.app/print/infants', {
        params: { worker_id: workerId },
      ...
      link.href = url;
      link.setAttribute('download', 'ZeroElevenMonths_Report.pdf');
  ...
  return (
    <div className="p-4">
      <MonthsInfant011CategoryDashboard
        countData={countData}
      ...
      <div className="flex justify-end mt-4">
        ...
        >
          Download 0-11 Months Old Infants Report
        </button>
      </div>
    </div>
  );
...
export default MonthsInfant011;
