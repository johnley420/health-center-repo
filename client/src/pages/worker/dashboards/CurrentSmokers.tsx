...
const CurrentSmokers: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          axios.get(`http://localhost:8081/currentsmokers/count-total-clients`, {
            params: { worker_id: workerId, category_name: "Current Smokers" },
          }),
          axios.get(`http://localhost:8081/currentsmokers/age-segmentation`, {
            params: { worker_id: workerId, category_name: "Current Smokers" },
          }),
          axios.get(`http://localhost:8081/currentsmokers/new-registered`, {
            params: { worker_id: workerId, category_name: "Current Smokers" },
          }),
          axios.get(`http://localhost:8081/currentsmokers/currentsmokers-data`, {
  ...
  const downloadPDF = async () => {
    try {
      ...
      const response = await axios.get('http://localhost:8081/print/currentsmokers', {
        params: { worker_id: workerId },
