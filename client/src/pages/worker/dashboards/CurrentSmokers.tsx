...
import CurrentSmokersCategoryDashboard from "../../../components/dashboard/CurrentSmokersCategoryDashboard";
...
// Props for CurrentSmokersCategoryDashboard
const CurrentSmokers: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          axios.get(`https://health-center-repo-production.up.railway.app/currentsmokers/count-total-clients`, {
            params: { worker_id: workerId, category_name: "Current Smokers" },
          }),
          axios.get(`https://health-center-repo-production.up.railway.app/currentsmokers/age-segmentation`, {
            params: { worker_id: workerId, category_name: "Current Smokers" },
          }),
          axios.get(`https://health-center-repo-production.up.railway.app/currentsmokers/new-registered`, {
            params: { worker_id: workerId, category_name: "Current Smokers" },
          }),
          axios.get(`https://health-center-repo-production.up.railway.app/currentsmokers/currentsmokers-data`, {
        ...
        setCountData([
          {
            label: "Total Clients",
            value: totalClients,
            description: "Total number of clients in Current Smokers Program Services.",
            active: true,
            withVariants: {
              male: maleClients,
  ...
  const downloadPDF = async () => {
    try {
      ...
      const response = await axios.get('https://health-center-repo-production.up.railway.app/print/currentsmokers', {
        params: { worker_id: workerId },
      ...
      link.href = url;
      link.setAttribute('download', 'CurrentSmokers_Report.pdf');
  ...
  return (
    <div className="p-4">
      <CurrentSmokersCategoryDashboard
        countData={countData}
      ...
      <div className="flex justify-end mt-4">
        ...
        >
          Download Current Smokers Report
        </button>
      </div>
    </div>
  );
