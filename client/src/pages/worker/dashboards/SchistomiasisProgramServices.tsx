...
const SchistomiasisProgramServices: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          axios.get(`https://health-center-repo-production.up.railway.app/schistomiasis/count-total-clients`, {
            params: { worker_id: workerId, category_name: "Schistomiasis Program Services" },
          }),
          axios.get(`https://health-center-repo-production.up.railway.app/schistomiasis/age-segmentation`, {
            params: { worker_id: workerId, category_name: "Schistomiasis Program Services" },
          }),
          axios.get(`https://health-center-repo-production.up.railway.app/schistomiasis/new-registered`, {
            params: { worker_id: workerId, category_name: "Schistomiasis Program Services" },
          }),
          axios.get(`https://health-center-repo-production.up.railway.app/schistomiasis/schistomiasis-data`, {
  ...
  const downloadPDF = async () => {
    try {
      ...
      const response = await axios.get('https://health-center-repo-production.up.railway.app/print/schistomiasis', {
        params: { worker_id: workerId },
