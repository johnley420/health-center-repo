...
import { SchistosomiasisForm } from "../../components/modals/forms/Schistosomiasis";
import axios from "axios";

const ViewSchistosomiasisTable = () => {
    ...
    const fetchClients = async () => {
      try {
        const response = await axios.get(
          `health-center-repo-production.up.railway.app/schistosomiasis/clients?worker_id=${workerId}&category_name=${encodeURIComponent(
  ...
  const handleAddForm = async (client: ClientType) => {
    ...
    try {
      const response = await axios.get(`health-center-repo-production.up.railway.app/schistosomiasis-form/${client.id}`);
  ...
  return (
    <div className="w-full p-2">
      ...
      <Table isStriped aria-label="Schistosomiasis data table">
        <TableHeader>
...
export default ViewSchistosomiasisTable;