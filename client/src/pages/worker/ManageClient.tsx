...
const ManageClient = () => {
  ...
  const fetchClients = async () => {
    setLoading(true);
    try {
      const response = await axios.get(`https://https://health-center-repo-production.up.railway.app/clients?workerId=${workerId}&status=active`);
  ...
  const fetchPendingClients = async () => {
    ...
    try {
      const response = await axios.get(`https://https://health-center-repo-production.up.railway.app/pending-clients?workerId=${workerId}`);
  ...
  const handleDeleteClient = async (clientId: number) => {
    ...
    try {
      const response = await axios.put(`https://https://health-center-repo-production.up.railway.app/clients/${clientId}/status`, {
        status: "Inactive",
      });
