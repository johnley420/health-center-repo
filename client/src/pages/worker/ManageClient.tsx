...
const ManageClient = () => {
  ...
  const fetchClients = async () => {
    setLoading(true);
    try {
      const response = await axios.get(`https://health-center-repo-production.up.railway.app/clients?workerId=${workerId}&status=active`);
  ...
  const fetchPendingClients = async () => {
    ...
    try {
      const response = await axios.get(`https://health-center-repo-production.up.railway.app/pending-clients?workerId=${workerId}`);
