...
const Inventory: React.FC = () => {
  ...
  const fetchMedicines = async () => {
    try {
      const response = await axios.get("https://https://health-center-repo-production.up.railway.app/medicines");
  ...
  try {
    ...
    const response = await axios.post("https://https://health-center-repo-production.up.railway.app/medicines", formData, {
      headers: {
  ...
  try {
    ...
    const response = await axios.put(
      `https://https://health-center-repo-production.up.railway.app/medicines/${updatedMedicine.id}`,
      formData,
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      await axios.delete(`https://https://health-center-repo-production.up.railway.app/medicines/${selectedMedicine.id}`);
    ...
    <TableRow key={medicine.id}>
      <TableCell>
        {typeof medicine.image === "string" && (
          <img
            src={`https://https://health-center-repo-production.up.railway.app/uploads/images/${medicine.image}`}
            alt={medicine.name}
            className="w-20"
          />
        )}
