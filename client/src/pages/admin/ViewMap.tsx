...
const ViewMap: React.FC = () => {
  ...
  useEffect(() => {
    ...
    axios.get("http://localhost:8081/clients-admin-map")
      .then((response) => {
    ...
    axios.get("http://localhost:8081/place-assign-coordinates")
      .then((response) => {
  ...
  useEffect(() => {
    if (selectedCategory !== null) {
      ...
      axios.get(`http://localhost:8081/clients-admin-map-high-risk`, {
        params: {
