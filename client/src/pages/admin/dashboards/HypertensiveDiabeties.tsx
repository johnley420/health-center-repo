    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          axios.get(`https://https://health-center-repo-production.up.railway.app/admin/hypertensivediabeties/count-total-clients`, {
            params: { category_name: "Hypertensive And Type 2 Diabetes" },
          }),
          axios.get(`https://https://health-center-repo-production.up.railway.app/admin/hypertensivediabeties/age-segmentation`, {
            params: { category_name: "Hypertensive And Type 2 Diabetes" },
          }),
          axios.get(`https://https://health-center-repo-production.up.railway.app/admin/hypertensivediabeties/new-registered`, {
            params: { category_name: "Hypertensive And Type 2 Diabetes" },
          }),
          axios.get(`https://https://health-center-repo-production.up.railway.app/admin/hypertensivediabeties/hypertensivediabeties-data`, {
