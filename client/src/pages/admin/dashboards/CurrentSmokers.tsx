    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          axios.get(`health-center-repo-production.up.railway.app/admin/currentsmokers/count-total-clients`, {
            params: {  category_name: "Current Smokers" },
          }),
          axios.get(`health-center-repo-production.up.railway.app/admin/currentsmokers/age-segmentation`, {
            params: {  category_name: "Current Smokers" },
          }),
          axios.get(`health-center-repo-production.up.railway.app/admin/currentsmokers/new-registered`, {
            params: { category_name: "Current Smokers" },
          }),
          axios.get(`health-center-repo-production.up.railway.app/admin/currentsmokers/currentsmokers-data`, {
