    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          axios.get(`health-center-repo-production.up.railway.app/admin/infants/count-total-clients`, {
            params: {  category_name: "0-11 Months Old Infants" },
          }),
          axios.get(`health-center-repo-production.up.railway.app/admin/infants/age-segmentation`, {
            params: {  category_name: "0-11 Months Old Infants" },
          }),
          axios.get(`health-center-repo-production.up.railway.app/admin/infants/new-registered`, {
            params: {  category_name: "0-11 Months Old Infants" },
          }),
          axios.get(`health-center-repo-production.up.railway.app/admin/infants/infants-data`, {
