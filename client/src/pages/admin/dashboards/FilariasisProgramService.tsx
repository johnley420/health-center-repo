    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          axios.get(`health-center-repo-production.up.railway.app/admin/filariasis/count-total-clients`, {
            params: { category_name: "Filariasis Program Services" },
          }),
          axios.get(`health-center-repo-production.up.railway.app/admin/filariasis/age-segmentation`, {
            params: {  category_name: "Filariasis Program Services" },
          }),
          axios.get(`health-center-repo-production.up.railway.app/admin/filariasis/new-registered`, {
            params: {  category_name: "Filariasis Program Services" },
          }),
          axios.get(`health-center-repo-production.up.railway.app/admin/filariasis/filariasis-data`, {
