    ...
    const fetchAdminData = async () => {
      try {
        ...
        const [
          ...
          axios.get(`health-center-repo-production.up.railway.app/admin/count-total-clients`),
          axios.get(`health-center-repo-production.up.railway.app/admin/count-worker`),
          axios.get(`health-center-repo-production.up.railway.app/admin/count-male-clients`),
          axios.get(`health-center-repo-production.up.railway.app/admin/count-female-clients`),
          axios.get(`health-center-repo-production.up.railway.app/admin/recent-clients`),
          axios.get(`health-center-repo-production.up.railway.app/admin/new-registered`),
          axios.get(`health-center-repo-production.up.railway.app/admin/category-count`),
          axios.get(`health-center-repo-production.up.railway.app/admin/age-segmentation`),
          axios.get(`health-center-repo-production.up.railway.app/admin/updates-line-graph`), // Fetch updates data
          axios.get(`health-center-repo-production.up.railway.app/admin/count-medicines`), // Fetch medicine count
        ]);
