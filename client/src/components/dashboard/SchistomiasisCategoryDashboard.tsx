// src/components/dashboard/SchistomiasisCategoryDashboard.tsx
...
interface SchistomiasisCategoryDashboardProps {
  countData: CountData[];
...
/**
 * SchistomiasisCategoryDashboard Component
 */
const SchistomiasisCategoryDashboard: React.FC<SchistomiasisCategoryDashboardProps> = ({
  countData,
  ageSegmentationData,
  newRegisteredData,
  updatesData,
...
export default SchistomiasisCategoryDashboard;
