// src/components/dashboard/PersonWithDisabilityCategoryDashboard.tsx
...
// Props for PersonWithDisabilityCategoryDashboard
interface PersonWithDisabilityCategoryDashboardProps {
  countData: CountData[];
...
/**
 * PersonWithDisabilityCategoryDashboard Component
 */
const PersonWithDisabilityCategoryDashboard: React.FC<PersonWithDisabilityCategoryDashboardProps> = ({
  countData,
  ageSegmentationData,
  newRegisteredData,
  updatesData,
...
export default PersonWithDisabilityCategoryDashboard;
