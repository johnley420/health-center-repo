// src/components/dashboard/SeniorCitizenCategoryDashboard.tsx
...
interface SeniorCitizenCategoryDashboardProps {
  countData: CountData[];
...
/**
 * SeniorCitizenCategoryDashboard Component
 */
const SeniorCitizenCategoryDashboard: React.FC<SeniorCitizenCategoryDashboardProps> = ({
  countData,
  ageSegmentationData,
  newRegisteredData,
  updatesData,
...
export default SeniorCitizenCategoryDashboard;
