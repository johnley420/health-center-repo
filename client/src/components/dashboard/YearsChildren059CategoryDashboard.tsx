// src/components/dashboard/YearsChildren059CategoryDashboard.tsx
...
// Props for YearsChildren059CategoryDashboard
interface YearsChildren059CategoryDashboardProps {
  countData: CountData[];
...
/**
 * YearsChildren059CategoryDashboard Component
 */
const YearsChildren059CategoryDashboard: React.FC<YearsChildren059CategoryDashboardProps> = ({
  countData,
  ageSegmentationData,
  newRegisteredData,
  updatesData,
...
export default YearsChildren059CategoryDashboard;
