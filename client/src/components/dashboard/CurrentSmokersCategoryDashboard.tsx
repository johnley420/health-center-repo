// src/components/dashboard/CurrentSmokersCategoryDashboard.tsx
...
interface CurrentSmokersCategoryDashboardProps {
  countData: CountData[];
...
/**
 * CurrentSmokersCategoryDashboard Component
 */
const CurrentSmokersCategoryDashboard: React.FC<CurrentSmokersCategoryDashboardProps> = ({
  countData,
  ageSegmentationData,
  newRegisteredData,
  updatesData,
...
export default CurrentSmokersCategoryDashboard;
