// src/components/dashboard/FamilyPlanningCategoryDashboard.tsx
...
interface FamilyPlanningCategoryDashboardProps {
  countData: CountData[];
...
/**
 * FamilyPlanningCategoryDashboard Component
 */
const FamilyPlanningCategoryDashboard: React.FC<FamilyPlanningCategoryDashboardProps> = ({
  countData,
  ageSegmentationData,
  newRegisteredData,
  updatesData,
...
export default FamilyPlanningCategoryDashboard;
