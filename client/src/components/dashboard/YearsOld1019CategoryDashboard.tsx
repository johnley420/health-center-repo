// src/components/dashboard/YearsOld1019CategoryDashboard.tsx
...
interface YearsOld1019CategoryDashboardProps {
  countData: CountData[];
...
/**
 * YearsOld1019CategoryDashboard Component
 */
const YearsOld1019CategoryDashboard: React.FC<YearsOld1019CategoryDashboardProps> = ({
  countData,
  ageSegmentationData,
  newRegisteredData,
  updatesData,
...
export default YearsOld1019CategoryDashboard;
