// src/components/dashboard/HypertensiveDiabetiesCategoryDashboard.tsx
...
interface HypertensiveDiabetiesCategoryDashboardProps {
  countData: CountData[];
...
/**
 * HypertensiveDiabetiesCategoryDashboard Component
 */
const HypertensiveDiabetiesCategoryDashboard: React.FC<HypertensiveDiabetiesCategoryDashboardProps> = ({
  countData,
  ageSegmentationData,
  newRegisteredData,
  updatesData,
...
export default HypertensiveDiabetiesCategoryDashboard;
