// src/components/dashboard/FilariasisCategoryDashboard.tsx
...
interface FilariasisCategoryDashboardProps {
  countData: CountData[];
...
/**
 * FilariasisCategoryDashboard Component
 */
const FilariasisCategoryDashboard: React.FC<FilariasisCategoryDashboardProps> = ({
  countData,
  ageSegmentationData,
  newRegisteredData,
  updatesData,
...
export default FilariasisCategoryDashboard;
