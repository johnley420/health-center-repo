// src/components/dashboard/YearsScreened059CategoryDashboard.tsx
...
interface YearsScreened059CategoryDashboardProps {
  countData: CountData[];
...
/**
 * YearsScreened059CategoryDashboard Component
 */
const YearsScreened059CategoryDashboard: React.FC<YearsScreened059CategoryDashboardProps> = ({
  countData,
  ageSegmentationData,
  newRegisteredData,
  updatesData,
...
export default YearsScreened059CategoryDashboard;
