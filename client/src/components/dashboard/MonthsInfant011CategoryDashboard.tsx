// src/components/dashboard/MonthsInfant011CategoryDashboard.tsx
...
interface MonthsInfant011CategoryDashboardProps {
  countData: CountData[];
...
/**
 * MonthsInfant011CategoryDashboard Component
 */
const MonthsInfant011CategoryDashboard: React.FC<MonthsInfant011CategoryDashboardProps> = ({
  countData,
  ageSegmentationData,
  newRegisteredData,
  updatesData,
...
export default MonthsInfant011CategoryDashboard;
