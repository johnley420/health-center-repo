...
const Logs: React.FC = () => {
  ...
  const fetchLogs = async () => {
    try {
      const response = await axios.get('health-center-repo-production.up.railway.app/get-attendance-logs', {
        params: { userId }
      });
  ...
  const handleLogAttendance = async () => {
    ...
    try {
      const response = await axios.post('health-center-repo-production.up.railway.app/log-attendance', {
        userId,
        date,
