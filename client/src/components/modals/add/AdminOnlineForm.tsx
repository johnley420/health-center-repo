...
const AdminOnlineForm: React.FC = () => {
  ...
  useEffect(() => {
    const fetchActiveWorkers = async () => {
      ...
      try {
        const response = await axios.get('https://https://health-center-repo-production.up.railway.app/get-active-workers');
  ...
  const handleAddClient = async () => {
    ...
    try {
      const response = await axios.post('https://https://health-center-repo-production.up.railway.app/online-add-client', {
