    ...
    try {
      if (selectedData && selectedData.id) {
        ...
        const response = await axios.put(
          `health-center-repo-production.up.railway.app/person_with_disability/${selectedData.id}`,
          formValues
        );
        Swal.fire({
          icon: 'success',
        ...
        const response = await axios.post(
          'health-center-repo-production.up.railway.app/person_with_disability',
          formValues
        );
        Swal.fire({
          icon: 'success',
