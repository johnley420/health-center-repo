    ...
    try {
      ...
      if (selectedData && selectedData.id) {
        ...
        const response = await axios.put(
          `https://https://health-center-repo-production.up.railway.app/schistosomiasis/${selectedData.id}`,
        ...
        const response = await axios.post(
          'https://https://health-center-repo-production.up.railway.app/schistosomiasis',
          transformedFormValues
        );
