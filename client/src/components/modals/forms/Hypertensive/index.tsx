    ...
    try {
      if (selectedData && selectedData.id) {
        ...
        const response = await axios.put(
          `https://https://health-center-repo-production.up.railway.app/hypertensive/${selectedData.id}`,
          formValues
        );
        Swal.fire({
          icon: 'success',
        ...
        const response = await axios.post(
          'https://https://health-center-repo-production.up.railway.app/hypertensive',
          formValues
        );
        Swal.fire({
          icon: 'success',
